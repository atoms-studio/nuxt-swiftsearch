...
See [`/examples`](/examples) for end-to-end patterns extracted from the playground (declarative layout, manual mode compatibility, multi-index isolation, route-driven filters, autocomplete, and pagination routing).
