...
- Most upstream changes are import-path updates to the ESM barrel files (`instantsearch.js/es/connectors/index.js`, `instantsearch.js/es/widgets/index.js`). The older `index.umd` paths under `es/connectors` and `es/widgets` were removed in **instantsearch.js 4.94+** ([algolia/instantsearch#6960](https://github.com/algolia/instantsearch/pull/6960)).
