  ...
  <div class="page">
    <ClientOnly>
      <AisInstantSearch index-name="instant_search" :search-client="searchClient">
        ...
        <AisSearchBox data-testid="searchbox" show-loading-indicator />
        ...
        <AisPanel data-testid="panel" header="Brand refinements" :collapsible="true" :class-names="panelClassNames">
          <template #default>
